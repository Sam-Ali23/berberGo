...
- 4 محلات تجريبية
- لكل محل 3 خدمات
- حوالي 10 حلاقين تجريبيين ببيانات إنجليزية
- عدة مواعيد تجريبية
- تقييم تجريبي
- محادثات تجريبية للعميل والإدارة

وللإنتاج أو أي قاعدة بيانات لا تريد مسحها:

```bash
npm run db:bootstrap-demo
```

هذا السكربت يضيف أو يحدّث نفس الحسابات والبيانات التجريبية الأساسية بدون حذف السجلات الحالية.
